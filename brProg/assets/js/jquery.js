!function(a, b) {
    ...
    var c = [], d = a.document, e = Object.getPrototypeOf, f = c.slice, g = c.concat, h = c.push, i = c.indexOf, j = {}, k = j.toString, l = j.hasOwnProperty, m = l.toString, n = m.call(Object), o = {}, q = "3.2.1", r = function(a, b) {
    ...
    r.fn = r.prototype = {
        ...
        camelCase: function(a) {
            return a.replace(/^-ms-/, "ms-").replace(/-([a-z])/g, v);
        },
        each: function(a, b) {
            var c, d = 0;
            ...
            if (!e && ((b ? b.ownerDocument || b : v) !== n && m(b), b = b || n, p)) {
                ...
                if (c.qsa && !A[a + " "] && (!q || !q.test(a))) {
                    if (1 !== w) s = b, r = a; else if ("object" !== b.nodeName.toLowerCase()) {
                        ...
                        o = g(a), h = o.length; h--; ) o[h] = "#" + k + " " + sa(o[h]);
    ...
    var y = function(a, b, c) {
        ...
        return c;
    }, A = r.expr.match.needsContext, C = /^<([a-z][^\/\0>:\x20\t\r\n\f]*)[\x20\t\r\n\f]*\/?>(?:<\/\1>|)$/i, D = /^.[^:#\[\.,]*$/;
        ...
        data: function(a, b) {
            ...
            if (void 0 === a) {
                if (this.length && (e = X.get(f), 1 === f.nodeType && !W.get(f, "hasDataAttrs"))) {
                    for (c = g.length; c--; ) g[c] && (d = g[c].name, 0 === d.indexOf("data-") && (d = r.camelCase(d.slice(5)), 
                    _(f, d, e[d])));
    ...
    r.event = {
        ...
        add: function(a, b, c, d, e) {
            ...
            if (q) for (c.handler && (f = c, c = f.handler, e = f.selector), e && r.find.matchesSelector(ra, e), 
            ...
            }), b = (b || "").match(L) || [ "" ], j = b.length; j--; ) h = ua.exec(b[j]) || [], 
        ...
        remove: function(a, b, c, d, e) {
            ...
            if (q && (i = q.events)) {
                for (b = (b || "").match(L) || [ "" ], j = b.length; j--; ) if (h = ua.exec(b[j]) || [], 
                n = p = h[1], o = (h[2] || "").split(".").sort(), n) {
                    for (l = r.event.special[n] || {}, n = (d ? l.delegateType : l.bindType) || n, m = i[n] || [], 
        ...
        off: function(a, b, c) {
            ...
            return !1 !== b && "function" != typeof b || (c = b, b = void 0), !1 === c && (c = wa), 
            this.each(function() {
                r.event.remove(this, a, c, b);
            });
        }
    });
    var Aa = /<script|<style|<link/i, Ba = /checked\s*(?:[^=]|=\s*.checked.)/i, Ca = /^true\/(.*)/, Da = /^\s*<!(?:\[CDATA\[|--)|(?:\]\]|--)>\s*$/g;
    r.extend({
    ...
    r.extend({
        ...
        style: function(a, b, c, d) {
            if (a && 3 !== a.nodeType && 8 !== a.nodeType && a.style) {
                ...
                "string" === f && (e = ba.exec(c)) && e[1] && (c = fa(a, b, e), f = "number"), void (null != c && c === c && ("number" === f && (c += e && e[3] || (r.cssNumber[h] ? "" : "px")), 
        ...
        css: function(a, b, c, d) {
            ...
            return Ra.test(b) || (b = Xa(h)), g = r.cssHooks[b] || r.cssHooks[h], g && "get" in g && (e = g.get(a, !0, c)), 
    ...
    r.fn.extend({
        ...
        toggleClass: function(a, b) {
            ...
            return "boolean" == typeof b && "string" === c ? b ? this.addClass(a) : this.removeClass(a) : r.isFunction(a) ? this.each(function(c) {
                ...
                var b, d, e, f;
                if ("string" === c) for (d = 0, e = r(this), f = a.match(L) || []; b = f[d++]; ) e.hasClass(b) ? e.removeClass(b) : e.addClass(b); else void 0 !== a && "boolean" !== c || (b = qb(this), 
                b && W.set(this, "__className__", b), this.setAttribute && this.setAttribute("class", b || !1 === a ? "" : W.get(this, "__className__") || ""));
            });
        },
        hasClass: function(a) {
            var b, c, d = 0;
    ...
    r.extend(r.event, {
        trigger: function(b, c, e, f) {
            ...
            n = r.event.special[p] || {}, f || !n.trigger || !1 !== n.trigger.apply(e, c))) {
                ...
                return b.type = p, f || b.isDefaultPrevented() || n._default && !1 !== n._default.apply(o.pop(), c) || !U(e) || k && r.isFunction(e[p]) && !r.isWindow(e) && (i = e[k], 
    ...
    var Eb = /^(.*?):[ \t]*([^\r\n]*)$/gm, Fb = /^(?:about|app|app-storage|.+-extension|file|res|widget):$/, Gb = /^(?:GET|HEAD)$/, Ib = {}, Jb = {}, Kb = "*/".concat("*"), Lb = d.createElement("a");
    Lb.href = tb.href, r.extend({
        ...
        ajax: function(b, c) {
            ...
            if (s.promise(y), o.url = ((b || o.url || tb.href) + "").replace(/^\/\//, tb.protocol + "//"), 
            ...
            o.hasContent = !Gb.test(o.type), f = o.url.replace(/#.*$/, ""), o.hasContent ? o.data && o.processData && 0 === (o.contentType || "").indexOf("application/x-www-form-urlencoded") && (o.data = o.data.replace(/%20/g, "+")) : (n = o.url.slice(f.length), 
            o.data && (f += (vb.test(f) ? "&" : "?") + o.data, delete o.data), !1 === o.cache && (f = f.replace(/([?&])_=[^&]*/, "$1"), 
